...
Paragraf selanjutnya harusnya berisi:
1. Penjelasan mengenai QR Code statis, serta bagaimana sistem e-ticket yang memanfaatkan QR Code statis bekerja. Carikan referensi/jurnal yang menjelaskan hal ini agar aku tinggal cross check dan kutulis ulang dengan bahasaku sendiri.
2. Penjelasan mengenai celah keamanan yang ada pada sistem e-ticket berbasis QR Code statis, seperti duplikasi tiket melalui screenshot, pemalsuan, dan percaloan digital, sertakan contoh kasus baik pada jurnal, penelitian, berita, ataupun pada draft paragraf selanjutnya yang sudah ditulis dibawah. Jangan lupa buatkan referensinya agar dapat aku cek ulang.
3. Karena draf paragraf selanjutnya sudah ada, dan berisikan masalah yang dijelaskan pada paragraf ini, maka kolabrorasi ide/poin-poin ini dengan draf paragraf tersebut agar menjadi satu kesatuan yang padu yang baik.
...
\textit{cari referensi/jurnal terkait penelitian sebelumnya, cek gapnya, apa metodenya, dan apa kebaruan dalam penelitian/TA ini.}
