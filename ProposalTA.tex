...
\usepackage{booktabs}
\usepackage{tabularx}  % Untuk tabel yang lebarnya otomatis pas
...
\usepackage[
    backend=biber,
    authordate,
    maxcitenames=2, % <--- TAMBAHKAN INI (Jika penulis > 2, akan diringkas)
    mincitenames=1, % <--- TAMBAHKAN INI (Diringkas menjadi 1 nama + dkk)
    language=english,
    autolang=other
]{biblatex-chicago}
...
\begin{center}
    ...
    {\Large\bfseries PEMANFAATAN TEKNOLOGI DYNAMIC SECURE QR CODE UNTUK MENINGKATKAN VALIDITAS DAN KEAMANAN TRANSAKSI E-TICKET}\\
     \vspace{4cm}
...
% ==========================================
	Pembimbing  \\[3cm]
	Dr. Yusuf Kurniawan S.T., M.T.   \\[0.2cm]
